...
nohup python3 -u main.py -d 'heart_disease' -i 3 -h 'offset_01' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log3_heart_disease_offset01_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 4 -h 'offset_01' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log4_heart_disease_offset01_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 5 -h 'offset_01' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log5_heart_disease_offset01_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 6 -h 'offset_01' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log6_heart_disease_offset01_standard_cost04.out &
...
nohup python3 -u main.py -d 'heart_disease' -i 3 -h 'biased' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log3_heart_disease_biased_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 4 -h 'biased' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log4_heart_disease_biased_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 5 -h 'biased' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log5_heart_disease_biased_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 6 -h 'biased' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log6_heart_disease_biased_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 7 -h 'biased' -r 'standard' -c 0.4 -n False -p '' -b False -w 'tr2stage' > ../logs/log7_heart_disease_biased_standard_cost04.out &
...
nohup python3 -u main.py -d 'heart_disease' -i 3 -h 'biased' -r 'standard' -c 0.4 -n False -p '_dec_bias' -b True -w 'tr2stage' > ../logs/log3_heart_disease_biasedDec_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 4 -h 'biased' -r 'standard' -c 0.4 -n False -p '_dec_bias' -b True -w 'tr2stage' > ../logs/log4_heart_disease_biasedDec_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 5 -h 'biased' -r 'standard' -c 0.4 -n False -p '_dec_bias' -b True -w 'tr2stage' > ../logs/log5_heart_disease_biasedDec_standard_cost04.out &
nohup python3 -u main.py -d 'heart_disease' -i 6 -h 'biased' -r 'standard' -c 0.4 -n False -p '_dec_bias' -b True -w 'tr2stage' > ../logs/log6_heart_disease_biasedDec_standard_cost04.out &
