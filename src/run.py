...
#run('heart_disease', 3, 'biased', runtype='standard', which_models=['brs','tr-no(ADB)','tr2stage', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 4, 'biased', runtype='standard', which_models=['brs','tr-no(ADB)','tr2stage', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
