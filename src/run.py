...
#run('heart_disease', 10, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 11, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 12, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 13, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 14, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 15, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 16, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 17, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 18, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 19, 'biased', runtype='standard', which_models=['tr-no(ADB)'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=False, custom_name='case1', use_true=False, subsplit=1)
