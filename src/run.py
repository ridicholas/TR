...
#run('heart_disease', 0, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 1, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 2, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 3, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 4, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 5, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 6, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 7, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 8, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)
#run('heart_disease', 9, 'biased', runtype='asym', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.0, remake_humans=True, human_decision_bias=True, custom_name='asymCase', use_true=False, subsplit=1)

#run('heart_disease', 0, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 1, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 2, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 3, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 4, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)

#run('heart_disease', 0, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1_cal', use_true=False, subsplit=1)
#run('heart_disease', 1, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1_cal', use_true=False, subsplit=1)
#run('heart_disease', 2, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1_cal', use_true=False, subsplit=1)
#run('heart_disease', 3, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1_cal', use_true=False, subsplit=1)
#run('heart_disease', 4, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='case1_cal', use_true=False, subsplit=1)
