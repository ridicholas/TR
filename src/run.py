...
run('heart_disease', 5, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.2, remake_humans=True, human_decision_bias=True, custom_name='case', use_true=False, subsplit=1)
run('heart_disease', 6, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.2, remake_humans=True, human_decision_bias=True, custom_name='case', use_true=False, subsplit=1)
run('heart_disease', 7, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.2, remake_humans=True, human_decision_bias=True, custom_name='case', use_true=False, subsplit=1)
run('heart_disease', 8, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.2, remake_humans=True, human_decision_bias=True, custom_name='case', use_true=False, subsplit=1)
run('heart_disease', 9, 'biased', runtype='standard', which_models=['brs', 'hyrs', 'tr'], contradiction_reg=0.2, remake_humans=True, human_decision_bias=True, custom_name='case', use_true=False, subsplit=1)
