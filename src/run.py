...
run('heart_disease', 0, 'biased', runtype='asym', which_models=['tr-no(ADB)','tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='asymFinal_newbehav', use_true=False, subsplit=1)
run('heart_disease', 1, 'biased', runtype='asym', which_models=['tr-no(ADB)','tr'], contradiction_reg=0.1, remake_humans=True, human_decision_bias=True, custom_name='asymFinal_newbehav', use_true=False, subsplit=1)
