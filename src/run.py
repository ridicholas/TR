...
#run('heart_disease', 0, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 1, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 2, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 3, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 4, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 5, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 6, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 7, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 8, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 9, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 10, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 11, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 12, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 13, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 14, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 15, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 16, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 17, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 18, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
#run('heart_disease', 19, 'biased', runtype='standard', which_models=['tr2stage'], contradiction_reg=0.1, remake_humans=False, human_decision_bias=True, custom_name='case1', use_true=False, subsplit=1)
