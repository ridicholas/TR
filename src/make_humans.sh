...
nohup python3 -u main.py -d 'fico' -i 0 -h 'biased' -r 'standard' -c 0 -n True -p '_dec_bias' -b True -w '' > ../logs/log0_fico_biased_dec_bias_standard_nomodels.out &
nohup python3 -u main.py -d 'fico' -i 1 -h 'biased' -r 'standard' -c 0 -n True -p '_dec_bias' -b True -w '' > ../logs/log1_fico_biased_dec_bias_standard_nomodels.out &
nohup python3 -u main.py -d 'fico' -i 2 -h 'biased' -r 'standard' -c 0 -n True -p '_dec_bias' -b True -w '' > ../logs/log2_fico_biased_dec_bias_standard_nomodels.out &
nohup python3 -u main.py -d 'fico' -i 3 -h 'biased' -r 'standard' -c 0 -n True -p '_dec_bias' -b True -w '' > ../logs/log3_fico_biased_dec_bias_standard_nomodels.out &
nohup python3 -u main.py -d 'fico' -i 4 -h 'biased' -r 'standard' -c 0 -n True -p '_dec_bias' -b True -w '' > ../logs/log4_fico_biased_dec_bias_standard_nomodels.out &
