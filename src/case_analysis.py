    ...
    for run in bar(range(num_runs)):
        ...
        for cost in costs:
            ...
            if run==0:
                ...
                tr_conf_confusion = [pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                brs_conf_confusion = [pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                tr_covered_confusion = [pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                tr_confusion = [pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                tr_model_confusion = [pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                hyrs_confusion = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                hyrs_model_confusion = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                brs_confusion = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                ...
                brs_model_confusion = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                ...
                human_confusion = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                ...
                tr_confusion_contras = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                hyrs_confusion_contras = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                tr_confusion_contras_accepted = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                tr_confusion_contras_correct = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                hyrs_confusion_contras_correct = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                totals_confusion = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                data = [[totals['em'], totals['ym'], totals['m']], 
                        [totals['ef'], totals['yf'], totals['f']], 
                        [totals['e'], totals['y'], totals['t']]])]
                
                brs_confusion_contras = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                ...
                brs_confusion_contras_correct = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                brs_confusion_contras_accepted = [pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                ...
                tr_confusion.append(pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(decs['em']['tr']), mean(decs['ym']['tr']), mean(decs['m']['tr'])], 
                                                    [mean(decs['ef']['tr']), mean(decs['yf']['tr']), mean(decs['f']['tr'])], 
                                                    [mean(decs['e']['tr']), mean(decs['y']['tr']), mean(decs['t']['tr'])]]))
                
                tr_conf_confusion.append(pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[tr_mod_confs[(x_test['ExternalRiskEstimate65.0'] == 1) &(x_test['NumSatisfactoryTrades24.0'] == 1) & (tr_model_preds_with_reset != human_decisions)].mean(), 
                                                     tr_mod_confs[(x_test['ExternalRiskEstimate65.0'] == 0) & (x_test['NumSatisfactoryTrades24.0'] == 1) & (tr_model_preds_with_reset != human_decisions)].mean(),
                                                     tr_mod_confs[(x_test['NumSatisfactoryTrades24.0'] == 1) & (tr_model_preds_with_reset != human_decisions)].mean()], 
                                                     [tr_mod_confs[(x_test['ExternalRiskEstimate65.0'] == 1) & (x_test['NumSatisfactoryTrades24.0'] == 0) & (tr_model_preds_with_reset != human_decisions)].mean(),
                ...
                tr_covered_confusion.append(pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(decs['em']['tr']), mean(decs['ym']['tr']), mean(decs['m']['tr'])], 
                                                    [mean(decs['ef']['tr']), mean(decs['yf']['tr']), mean(decs['f']['tr'])], 
                                                    [mean(decs['e']['tr']), mean(decs['y']['tr']), mean(decs['t']['tr'])]]))
                
                brs_conf_confusion.append(pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                data = [[brs_conf[(x_test['ExternalRiskEstimate65.0'] == 1) &(x_test['NumSatisfactoryTrades24.0'] == 1) & (brs_model_preds != human_decisions)].mean(), 
                                         brs_conf[(x_test['ExternalRiskEstimate65.0'] == 0) & (x_test['NumSatisfactoryTrades24.0'] == 1) & (brs_model_preds != human_decisions)].mean(),
                                         brs_conf[(x_test['NumSatisfactoryTrades24.0'] == 1) & (brs_model_preds != human_decisions)].mean()], 
                                         [brs_conf[(x_test['ExternalRiskEstimate65.0'] == 1) & (x_test['NumSatisfactoryTrades24.0'] == 0) & (brs_model_preds != human_decisions)].mean(),
                ...
                brs_model_confusion.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                data = [[mean(model_decs['em']['brs']), mean(model_decs['ym']['brs']), mean(model_decs['m']['brs'])], 
                        [mean(model_decs['ef']['brs']), mean(model_decs['yf']['brs']), mean(model_decs['f']['brs'])], 
                        [mean(model_decs['e']['brs']), mean(model_decs['y']['brs']), mean(model_decs['t']['brs'])]]))
                
                tr_model_confusion.append(pd.DataFrame(dtype = 'float', index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(model_decs['em']['tr']), mean(model_decs['ym']['tr']), mean(model_decs['m']['tr'])], 
                                                    [mean(model_decs['ef']['tr']), mean(model_decs['yf']['tr']), mean(model_decs['f']['tr'])], 
                                                    [mean(model_decs['e']['tr']), mean(model_decs['y']['tr']), mean(model_decs['t']['tr'])]]))
                
                hyrs_confusion.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(decs['em']['hyrs']), mean(decs['ym']['hyrs']), mean(decs['m']['hyrs'])], 
                                                    [mean(decs['ef']['hyrs']), mean(decs['yf']['hyrs']), mean(decs['f']['hyrs'])], 
                                                    [mean(decs['e']['hyrs']), mean(decs['y']['hyrs']), mean(decs['t']['hyrs'])]]))
                
                hyrs_model_confusion.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(model_decs['em']['hyrs']), mean(model_decs['ym']['hyrs']), mean(model_decs['m']['hyrs'])], 
                                                    [mean(model_decs['ef']['hyrs']), mean(model_decs['yf']['hyrs']), mean(model_decs['f']['hyrs'])], 
                                                    [mean(model_decs['e']['hyrs']), mean(model_decs['y']['hyrs']), mean(model_decs['t']['hyrs'])]]))
                
                hyrs_confusion_contras.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                            data = [[mean(contras['em']['hyrs']), mean(contras['ym']['hyrs']), mean(contras['m']['hyrs'])], 
                                    [mean(contras['ef']['hyrs']), mean(contras['yf']['hyrs']), mean(contras['f']['hyrs'])], 
                                    [mean(contras['e']['hyrs']), mean(contras['y']['hyrs']), mean(contras['t']['hyrs'])]]))
                
                brs_confusion.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                data = [[mean(decs['em']['brs']), mean(decs['ym']['brs']), mean(decs['m']['brs'])], 
                        [mean(decs['ef']['brs']), mean(decs['yf']['brs']), mean(decs['f']['brs'])], 
                        [mean(decs['e']['brs']), mean(decs['y']['brs']), mean(decs['t']['brs'])]]))
                

                human_confusion.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                                            data= [[mean(decs['em']['human']), mean(decs['ym']['human']), mean(decs['m']['human'])], 
                                                    [mean(decs['ef']['human']), mean(decs['yf']['human']), mean(decs['f']['human'])], 
                                                    [mean(decs['e']['human']), mean(decs['y']['human']), mean(decs['t']['human'])]]))

                tr_confusion_contras.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(contras['em']['tr']), mean(contras['ym']['tr']), mean(contras['m']['tr'])], 
                                                    [mean(contras['ef']['tr']), mean(contras['yf']['tr']), mean(contras['f']['tr'])], 
                                                    [mean(contras['e']['tr']), mean(contras['y']['tr']), mean(contras['t']['tr'])]]))
                tr_confusion_contras_accepted.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(accepted_contras['em']['tr']), mean(accepted_contras['ym']['tr']), mean(accepted_contras['m']['tr'])], 
                                                    [mean(accepted_contras['ef']['tr']), mean(accepted_contras['yf']['tr']), mean(accepted_contras['f']['tr'])], 
                                                    [mean(accepted_contras['e']['tr']), mean(accepted_contras['y']['tr']), mean(accepted_contras['t']['tr'])]]))
                
                tr_confusion_contras_correct.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(correct_contras['em']['tr']), mean(correct_contras['ym']['tr']), mean(correct_contras['m']['tr'])], 
                                                    [mean(correct_contras['ef']['tr']), mean(correct_contras['yf']['tr']), mean(correct_contras['f']['tr'])], 
                                                    [mean(correct_contras['e']['tr']), mean(correct_contras['y']['tr']), mean(correct_contras['t']['tr'])]]))
                
                hyrs_confusion_contras_correct.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                            data = [[mean(correct_contras['em']['hyrs']), mean(correct_contras['ym']['hyrs']), mean(correct_contras['m']['hyrs'])], 
                                    [mean(correct_contras['ef']['hyrs']), mean(correct_contras['yf']['hyrs']), mean(correct_contras['f']['hyrs'])], 
                                    [mean(correct_contras['e']['hyrs']), mean(correct_contras['y']['hyrs']), mean(correct_contras['t']['hyrs'])]]))
                
                totals_confusion.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                data = [[totals['em'], totals['ym'], totals['m']], 
                        [totals['ef'], totals['yf'], totals['f']], 
                        [totals['e'], totals['y'], totals['t']]]))
                
                brs_confusion_contras.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'],
                data = [[mean(contras['em']['brs']), mean(contras['ym']['brs']), mean(contras['m']['brs'])], 
                        [mean(contras['ef']['brs']), mean(contras['yf']['brs']), mean(contras['f']['brs'])], 
                        [mean(contras['e']['brs']), mean(contras['y']['brs']), mean(contras['t']['brs'])]]))
                
                brs_confusion_contras_correct.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(correct_contras['em']['brs']), mean(correct_contras['ym']['brs']), mean(correct_contras['m']['brs'])], 
                                                    [mean(correct_contras['ef']['brs']), mean(correct_contras['yf']['brs']), mean(correct_contras['f']['brs'])], 
                                                    [mean(correct_contras['e']['brs']), mean(correct_contras['y']['brs']), mean(correct_contras['t']['brs'])]]))
                
                brs_confusion_contras_accepted.append(pd.DataFrame(index=['ManyTrades', 'FewTrades', 'Total'], columns=['Risky', 'NotRisky', 'Total'], 
                                            data = [[mean(accepted_contras['em']['brs']), mean(accepted_contras['ym']['brs']), mean(accepted_contras['m']['brs'])], 
                                                    [mean(accepted_contras['ef']['brs']), mean(accepted_contras['yf']['brs']), mean(accepted_contras['f']['brs'])], 
                                                    [mean(accepted_contras['e']['brs']), mean(accepted_contras['y']['brs']), mean(accepted_contras['t']['brs'])]]))
