...
def make_multi_TL_v_cost_plot(results_means, results_stderrs, name, ax, stopat=6, rocs_dict=None):
...
fig.tight_layout()
fig.savefig(f'results/combined_plots_final_discretion.png', dpi=400)
