    ...
    def heart_confidence_transformation(self, X=None, t_type=None):
        ...
        if t_type=='biased':
            ...
            if self.decision_bias == False:
                ...
                confidences[(X['sex_Male'] == 0) & (X['age54.0'] == 1)] = 1 #strong
                confidences[(X['sex_Male'] == 1) & (X['age54.0'] == 0)] = 1 #strong
                confidences[(X['sex_Male'] == 0) & (X['age54.0'] == 0)] = 0.2 #strong
                confidences[(X['sex_Male'] == 1) & (X['age54.0'] == 1)] = 0.2 #weak
                #########################################################
